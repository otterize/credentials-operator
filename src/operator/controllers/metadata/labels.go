...
const (
	...
	// OtterizeAWSUseSoftDelete is used to mark workloads that should not have their corresponding roles deleted,
	// but should be tagged as deleted instead (aka soft delete strategy).
	OtterizeAWSUseSoftDelete = "credentials-operator.otterize.com/aws-use-soft-delete"
)
