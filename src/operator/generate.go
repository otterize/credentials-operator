...
//go:generate go run go.uber.org/mock/mockgen@v0.2.0 -destination=mocks/gcp/mock2.go github.com/otterize/credentials-operator/src/controllers/gcp_iam/gcp_service_accounts/gcp_service_accounts_controller GCPServiceAccountManager
